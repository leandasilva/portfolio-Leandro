    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black text-white">
      ...
      <section className="py-20 px-6 bg-gray-900">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 max-w-5xl mx-auto text-center">
          {['Angular', 'Angular Material', 'Node.js', 'Express', 'PL/SQL', 'TailwindCSS', 'Jest', 'java', 'Oracle', 'GitLab', 'Spring Boot','Figma']
            .map((tech) => (
      ...
      <section className="py-20 px-6 bg-gray-50 text-gray-900">
        ...
        <p className="max-w-3xl mx-auto text-center text-gray-700">
            Participé en el desarrollo completo del sitio, integrando el frontend en Angular con Angular Material,
